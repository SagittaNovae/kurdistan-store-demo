...
return [
    ...
    'phone' => [
        // Allowed country calling codes (E.164 prefix). Configurable for future expansion.
        'allowed_country_codes' => explode(',', env('PHONE_ALLOWED_COUNTRIES', '+964')),
        // E.164 pattern that all submitted phone numbers must match AFTER normalisation.
        'e164_pattern' => env('PHONE_E164_PATTERN', '^\+9647\d{9}$'),
        // Default country code used when normalising local numbers (e.g. 0750… → +964750…).
