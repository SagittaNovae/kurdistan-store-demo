@component('shop::emails.layout')
    ...
    @slot('preheader')@lang('shop::app.emails.customers.registration.preheader')@endslot
        ...
        <tr>
            <td style="padding-top: 12px;">
                <p style="margin: 0; font-family: 'Inter', sans-serif; font-size: 15px; color: #888888; line-height: 26px;">
                    @lang('shop::app.emails.dear', ['customer_name' => $customer->name]) — @lang('shop::app.emails.customers.registration.greeting')
                </p>
            </td>
        </tr>
    </table>
